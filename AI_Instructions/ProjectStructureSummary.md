...
Files prefixed with `DURC_` are auto-generated by the DURC (Database Utility Report Creator) sister project. DURC generates ZZermelo reports for each table in a database. For ZZermelo development, these should be treated as "just more reports" - ZZermelo must function independently of DURC.
